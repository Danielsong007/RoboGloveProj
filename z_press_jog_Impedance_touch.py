...
def main():
    try:
        ...
        while True:
            ...
            if current_touch_force < 750:
                ...
                if Pnum % 10 == 0:
                    print(
                        'Mode:', mode,
                        'Pres_F:', int(current_touch_force),
                ...
                while current_touch_force > 600:
                    ...
                    last_mode = mode
                    balance_force = 1000
                    human_force = current_touch_force - balance_force
                    if human_force < 0:
                        human_force = human_force*2.5
                    ...
                    plt_pres.append(int(current_touch_force))
                    plt_human.append(int(human_force))
                    plt_BdN.append(int(ic_touch.Bd*Vgoal))
                    plt_acc.append(int(ic_touch.current_acceleration))
                    plt_vgoal.append(int(Vgoal)/20)
                    myXYZ.AxisMode_Jog(3, 30, Vgoal)
                    Pnum += 1
        ...
        plt.plot(x, plt_BdN, 'b-', label='BdN', linewidth=1.5)
        plt.plot(x, plt_human, 'r-', label='human', linewidth=1.5)
        plt.plot(x, plt_acc, 'g-', label='acc', linewidth=1.5)
        plt.plot(x, plt_vgoal, 'k-', label='vgoal', linewidth=1.5)
        plt.legend()
